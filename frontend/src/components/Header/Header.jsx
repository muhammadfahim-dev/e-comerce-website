...
function Header() {
    return (
        <div className='h-[40vh] md:h-[34vw] w-[100%] bg-[url(https://your-app-name.vercel.app/header_img.png)] bg-cover bg-no-repeat overflow-hidden rounded-2xl py-auto relative'>
